...
const Update = ({id, updatePirate}) =>{
    ...
    axios.put(`http://localhost:8000/api/pirates/${id}`, /*add other properties*/{name:name, url:url, treasureChests: treasureChests,phrase: phrase,position: position, pegLeg: pegLeg, eyePatch:eyePatch,hookHand:hookHand})
    .then(res=>{
        console.log(res);
    ...
    return(
            ...
            <div>
                ...
                <label>
                    ...
                    <input  type="checkbox"  onChange={e=>setPegLeg(e.target.checked)} />
